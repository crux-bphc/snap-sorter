...
<main class="align-between m-auto flex flex-col gap-5">
	...
	<div>
		...
		<div class="mb-4 grid grid-cols-3 place-items-stretch gap-4">
			{#each images as { src, height, width, name, size }}
				<div class="flex w-52 flex-col items-center justify-center gap-2 bg-purple-50 p-2">
					<img alt="" {src} class="max-h-48" />
